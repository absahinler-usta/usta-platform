...
export default function GirisIsVerenPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem("userType", response.user.userType || "is-veren");
      

      alert("Giriş başarılı!");
      window.location.href = "/dashboard-is-veren";
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-ustablue mb-2">İş Veren Giriş</h1>
          <p className="text-gray-600">Firma hesabınıza giriş yapın</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="text-center mt-6 pt-6 border-t border-gray-200">
            <p className="text-sm text-gray-600">
              Hesabın yok mu?{" "}
              <Link href="/giris/kayit-is-veren" className="text-ustablue font-bold hover:underline">
                Kayıt Ol
              </Link>
            </p>
          </div>
